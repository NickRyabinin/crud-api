...
/**
 * Роутер.
 * Выбирает контроллер из DI-контейнера, по имени запрашиваемого пользователем ресурса.
 * В зависимости от метода запроса, вызывает определённый метод выбранного контроллера.
 */
